...
PATH_OPTICS = '/Users/currodri/Documents/Github/DustRAMSES/'
PATH_TABLES = '/Users/currodri/Documents/Github/DustRAMSES/dust_oppacity_tables/'
# Functions
...
def plot_sil_comp():
    ...
    nwav,data,columns,name = dust_efficiencies('draine_lee_1984/Sil_21')
    nwav_suv,data_suv,columns_suv,name_suv = dust_efficiencies('draine_lee_1984/suvSil_21')
...
def interpolate_cross_sections_2d(dust_type, grain_size, target_wavelengths=None,
    ...
    if data_table is None:
        if dust_type == 'silicate':
            filename = PATH_OPTICS+'/draine_lee_1984/suvSil_81'
            nwav, data, columns, name = dust_efficiencies(filename)
        elif dust_type == 'graphite':
            filename = PATH_OPTICS+'/draine_lee_1984/Gra_81'
            nwav, data, columns, name = dust_efficiencies(filename)
        elif dust_type == 'iPAH':
            filename = PATH_OPTICS+'/li_draine_2001/PAHion_30'
            nwav, data, columns, name = pah_efficiencies(filename)
        elif dust_type == 'nPAH' or dust_type == 'PAH':
            filename = PATH_OPTICS+'/li_draine_2001/PAHneu_30'
            nwav, data, columns, name = pah_efficiencies(filename)
        else:
...
def compute_extinction_curve(dust_types, dists, mass_fractions,
    ...
    Example usage
    -------------
    nwav,data,columns,name = dust_efficiencies('draine_lee_1984/Gra_81')
    ...
    for icomp, (dist,material) in enumerate(zip(dists, dust_types)):
        ...
        if material == 'silicate':
            ...
            filename = PATH_OPTICS+'li_draine_2001/PAHion_30'
            nwav, data, columns, name = pah_efficiencies(filename)
        elif material == 'nPAH' or material == 'PAH':
            filename = PATH_OPTICS+'li_draine_2001/PAHneu_30'
            nwav, data, columns, name = pah_efficiencies(filename)
        else:
        ...
        kappas_comp[icomp,:] = np.trapz(kappa_dist, size_bins, axis=0)  # cm^2/g
